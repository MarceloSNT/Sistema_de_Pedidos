const cardapioProdutos = [
  ...
  { imagem: "../IMG/hot-dog-tradicional.jpg", nome: "Hot Dog Tradicional", preco: 14.0},
  { imagem: "../IMG/hot-dog-supreme.jpg", nome: "Hot Dog Supreme", preco: 18.0 },
  { imagem: "../IMG/hot-dog-prato.jpg", nome: "Hot Dog no Prato", preco: 22.0 },
  { imagem: "../IMG/salada.jpg", nome: "Crunch Salad Combo", preco: 31.4 },
  { imagem: "../IMG/combo-bacon-fritas.jpg", nome: "Double Bacon Combo", preco: 34.0 },
  { imagem: "../IMG/frango-fritas.jpg", nome: "Combo Frango + Fritas ", preco: 37.2 },
  { imagem: "../IMG/beirute.jpg", nome: "Beirut Clássico", preco: 6.0 },
  { imagem: "../IMG/beirut-especial.jpg", nome: "Beirut Especial", preco: 8.0 },
  { imagem: "../IMG/misto-quente.jpg",nome: "Queijo Quente Clássico", preco: 11.0 },
...
function addProdutoCarrinho() {
  mostrarProdutos.addEventListener("click", (event) => {
    ...
    const index = [
      ...mostrarProdutos.querySelectorAll(".btn-adicionar"),
    ].indexOf(event.target);
    const produto = cardapioProdutos[index];
    const inputQuant =
      mostrarProdutos.querySelectorAll(".input-quantidade")[index];
